    ...
    $.widget('mage.productGallery', {
        ...
        _addItem: function (event, imageData) {
            ...
            imageData = $.extend({
                ...
                'dimension': imageData.dimension ? imageData.dimension : 0,
                'position': position,
    ...
    $.widget('mage.productGallery', $.mage.productGallery, {
        ...
        _initDialog: function () {
            ...
            $dialog.on('close', function () {
                ...
                $dialog.find('#display-image-from-product-page').remove();
            });
            ...
            /* Custom code start */
            $dialog.on('change', '[data-role=visibility-trigger-display-image]', $.proxy(function (e) {
                var imageData = $dialog.data('imageData');

                this.element.trigger('updateVisibility', {
                    dimension: $(e.currentTarget).is(':checked'),
                    imageData: imageData
                });
            }, this));
            /* Custom code end */
        ...
        _updateVisibility: function (event, data) {
            ...
            $imageContainer.find('[name*="dimension"]').val(dimension);
            imageData.dimension = dimension;
