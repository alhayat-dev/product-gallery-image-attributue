...
namespace Alhayat\DimensionImageAttribute\Model\ResourceModel\Product;
...
class Gallery extends \Magento\Catalog\Model\ResourceModel\Product\Gallery
{
    public function createBatchBaseSelect($storeId, $attributeId)
    {
        ...
        $select = $this->getConnection()->select()->from(
            ...
            ['label', 'position', 'disabled', 'dimension']
        )->joinLeft(
            ...
            ['label_default' => 'label', 'position_default' => 'position', 'disabled_default' => 'disabled', 'dimension_default' => 'dimension']
        )->where(
